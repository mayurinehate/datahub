...
grant references on all dynamic tables in database "<your-database>" to role datahub_role;
grant references on future dynamic tables in database "<your-database>" to role datahub_role;
