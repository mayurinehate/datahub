...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("project.dataset.20231215", None, "20231215"),
        # Cases with Just the table name as input
        ("table", "table", None),
        # FIXME : ("table20231215", "table", "20231215"),
        ("table_20231215", "table", "20231215"),
        ("table_1624046611000_name", "table_1624046611000_name", None),
        # FIXME : ("table_1624046611000", "table_1624046611000", None),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("project.dataset.20231215", None, "20231215"),
        ("project.dataset.2023", None, "2023"),
        # Cases with Just the table name as input
        ("table", "table", None),
        # FIXME : ("table20231215", "table", "20231215"),
        ("table_20231215", "table", "20231215"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # FIXME : ("project.dataset.table_1624046611000", "project.dataset.table_1624046611000"),
        # FIXME : ("project.dataset.table20231215", "project.dataset.table"),
